...
All rights reserved. This code is provided solely for evaluation in the Gemini 3 Hackathon. You may not use, copy, modify, merge, publish, distribute, sublicense, or sell any part of this codebase without the author's explicit written permission.
